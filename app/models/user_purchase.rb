class UserPurchase
  ...
  attr_accessor :token, :postal_code, :delivery_prefecture_id, :city, :house_number, :building_name, :phone_number, :item_id, :user_id
  ...
  with_options presence: true do
    ...
    validates :phone_number, format: {with: /0\d{8,9}\z/, message: "is invalid. Input half-width characters."}
  end
